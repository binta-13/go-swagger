...
import (
	...
	"github.com/gosawgger/restapi/operations"
	"github.com/gosawgger/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../gosawgger --name TodoList --spec ../swagger.yml --principal interface{}
